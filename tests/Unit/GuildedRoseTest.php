    ...
    public function itemProvider(): array
    {
        return [
            ...
            'brie item before sell date with maximum quality' => [
                'item' => new AgedItem('Aged Brie', 50, 5),
                'expectedQuality' => 50,
                'expectedSellIn' => 4,
            ],
            'brie item on sell date' => [
                'item' => new AgedItem('Aged Brie', 10, 0),
                'expectedQuality' => 12,
                'expectedSellIn' => -1,
            ],
            'brie item on sell date near maximum quality' => [
                'item' => new AgedItem('Aged Brie', 49, 0),
                'expectedQuality' => 50,
                'expectedSellIn' => -1,
            ],
            'brie item on sell date with maximum quality' => [
                'item' => new AgedItem('Aged Brie', 50, 0),
                'expectedQuality' => 50,
                'expectedSellIn' => -1,
            ],
            'brie item after sell date' => [
                'item' => new AgedItem('Aged Brie', 10, -10),
                'expectedQuality' => 12,
                'expectedSellIn' => -11,
            ],
            'brie item after sell date with maximum quality' => [
                'item' => new AgedItem('Aged Brie', 50, -10),
                'expectedQuality' => 50,
                'expectedSellIn' => -11,
            ],
            ...
            'sulfuras item before sell date' => [
                'item' => new LegendaryItem('Sulfuras, Hand of Ragnaros', 10, 5),
                'expectedQuality' => 10,
                'expectedSellIn' => 5,
            ],
            ...
            'sulfuras item after sell date' => [
                'item' => new LegendaryItem('Sulfuras, Hand of Ragnaros', 10, -1),
                'expectedQuality' => 10,
                'expectedSellIn' => -1,
            ],
            ...
            'backstage pass close to sell date' => [
                'item' => new BackstagePassItem('Backstage passes to a TAFKAL80ETC concert', 10, 10),
                'expectedQuality' => 12,
                'expectedSellIn' => 9,
            ],
            'backstage pass close to sell date at maximum quality' => [
                'item' => new BackstagePassItem('Backstage passes to a TAFKAL80ETC concert', 50, 10),
                'expectedQuality' => 50,
                'expectedSellIn' => 9,
            ],
            'backstage pass very close to sell date' => [
                'item' => new BackstagePassItem('Backstage passes to a TAFKAL80ETC concert', 10, 5),
                'expectedQuality' => 13,
                'expectedSellIn' => 4,
            ],
            'backstage pass very close to sell date at maximum quality' => [
                'item' => new BackstagePassItem('Backstage passes to a TAFKAL80ETC concert', 50, 5),
                'expectedQuality' => 50,
                'expectedSellIn' => 4,
            ],
            'backstage pass with one day left to sell' => [
                'item' =>  new BackstagePassItem('Backstage passes to a TAFKAL80ETC concert', 10, 1),
                'expectedQuality' => 13,
                'expectedSellIn' => 0,
            ],
            'backstage pass with one day left to sell at maximum quality' => [
                'item' =>  new BackstagePassItem('Backstage passes to a TAFKAL80ETC concert', 50, 1),
                'expectedQuality' => 50,
                'expectedSellIn' => 0,
            ],
            'backstage pass on sell date' => [
                'item' =>  new BackstagePassItem('Backstage passes to a TAFKAL80ETC concert', 10, 0),
                'expectedQuality' => 0,
                'expectedSellIn' => -1,
            ],
            ...
            'conjured item at zero quality' => [
                'item' => new ConjuredItem('Conjured Mana Cake', 0, 10),
                'expectedQuality' => 0,
                'expectedSellIn' => 9,
            ],
            'conjured item on sell date' => [
                'item' => new ConjuredItem('Conjured Mana Cake', 10, 0),
                'expectedQuality' => 6,
                'expectedSellIn' => -1,
            ],
            'conjured item on sell date at zero quality' => [
                'item' => new ConjuredItem('Conjured Mana Cake', 0, 0),
                'expectedQuality' => 0,
                'expectedSellIn' => -1,
            ],
